...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ossfs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13463&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ossfs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ossfs` can be installed with:

```
conda install ossfs
```

It is possible to list all of the versions of `ossfs` available on your platform with:
